...
| 02b   | [世界観設定書](02b-world-setting.md)                                | ドラフト | **世界観の正**。核の一文と四つのアプローチ(本質は生活の暖かみ)、時代・都市・社会規範、暖かさ・象徴・厳しさ、語り口。GDD より上に置き、全分冊・アート・台詞が同じ世界を指すための基準(開発者・アート・マーケ視点) |
| 02c   | [正式タイトルの検討](02c-title-study.md)                            | 検討中   | 命名方針・候補・評価・衝突調査。決まったら凍らせる |
