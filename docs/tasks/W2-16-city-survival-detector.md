...
| 3 | 「3品目とも0の世帯」が**全世帯ではない** | 全世帯が3品目とも0 | [GDD02b §1](../03-gdd/02b-consumption-and-household.md) / [GDD02 §8](../03-gdd/02-economy.md)-2 |
...
- **`Purchase` だけ数えるのは二重計上を避けるためである**([GDD01 §4.4](../03-gdd/01-trust-and-conversation.md)。1約定は買い手と売り手が1行ずつ記帳する)。`Sale` を足すと件数が2倍になり、**窓口への輸出も混ざる**
